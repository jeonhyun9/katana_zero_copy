...
void playerClass::update()
{
	...
	{
		setHurtSwith ? setHurtSwith = false : setHurtSwith = true;
	}
...
void playerClass::render()
{
	...
	{
		landDust.img->frameRender(getMemDC(), landDust.x - DATA->getBgCol().x, landDust.y - DATA->getBgCol().y, landDust.frameIdx, 0);
	}
