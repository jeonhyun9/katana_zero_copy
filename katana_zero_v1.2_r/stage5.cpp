...
void stage5::render()
{
	...
	if (DATA->getRenderUi())
	{
		...
		switch (bossPt->getBoss().currentPattern)
		{
		case 8: sprintf(str2, "boss life : 0");
			break;
		case 7: sprintf(str2, "boss life : 0");
			break;
		case 6: sprintf(str2, "boss life : 1");
			break;
		case 5: sprintf(str2, "boss life : 2");
			break;
		case 4: sprintf(str2, "boss life : 3");
			break;
		case 3: sprintf(str2, "boss life : 4");
			break;
		case 2: sprintf(str2, "boss life : 5");
			break;
		case 1: sprintf(str2, "boss life : 6");
			break;
		case 0: sprintf(str2, "boss life : 7");
			break;
		}

		TextOut(getMemDC(), 1022, 8, str2, strlen(str2));
	}
