...
HRESULT stage2::init()
{
	...
	//2층 문 위
	enemyPt->generateEnemy(2880, 443, E_BOLD, E_IDLE, false);
	...
	//2층 두번째 문 아래
	itemPt->generateItem(3300, 715, I_BUST);
	itemPt->generateItem(3305, 743, I_BOTTLE);
	itemPt->generateItem(3300, 738, I_KNIFE);

	enemyPt->generateEnemy(3639, 681, E_POMP, E_IDLE, false);
	enemyPt->generateEnemy(3689, 681, E_GRUNT, E_IDLE, false);
	enemyPt->generateEnemy(3739, 681, E_COP, E_IDLE, false);
