...
void loadingScene::loadingImage()
{
	...
	_loading->loadImage("hud_go_font", "images/hud_go_font.bmp", 78, 40);
	_loading->loadImage("hud_go_arrow", "images/hud_go_arrow.bmp", 62, 38);
	...
	_loading->loadFrameImage("player_run_shadow", "images/player/player_run_shadow_10x2.bmp", 880, 128, 10, 2);
	...
	_loading->loadFrameImage("player_song","images/player/player_song_31x2.bmp", 2232, 156, 31, 2);
	_loading->loadFrameImage("wallJumpDust","images/player/player_jumpdust_wall_2x5.bmp", 160, 210, 2, 5);
	_loading->loadFrameImage("dust","images/player/player_dust_7x1.bmp", 238, 28, 7, 1);
	_loading->loadFrameImage("jumpdust", "images/player/player_jumpdust_5x1.bmp", 210, 80,5,1);
	_loading->loadFrameImage("landdust", "images/player/player_landdust_8x1.bmp", 660, 16,8,1);

	/*에너미*/
	_loading->loadImage("enemy_bullet", "images/enemy/enemy_bullet.bmp", 48, 2);
	_loading->loadImage("enemy_follow", "images/enemy/enemy_follow.bmp", 16, 20);
	...
	_loading->loadFrameImage("effect_reflect", "images/effect/effect_reflect_6x2.bmp", 883, 280, 6, 2);
	...
	_loading->loadImage("effect_hit_lazer", "images/effect/effect_hit_lazer.bmp", 900, 4);
	...
	_loading->loadImage("effect_success", "images/effect/effect_success.bmp", 1280, 720);
	_loading->loadImage("effect_black", "images/effect/effect_black.bmp", 1280, 720);
	_loading->loadImage("effect_fail", "images/effect/effect_fail.bmp", 1280, 720);
	_loading->loadImage("effect_end", "images/effect/effect_end.bmp", 1280, 720);
	_loading->loadImage("effect_madeby", "images/effect/effect_madeby.bmp", 1280, 720);

	/*오브젝트*/
	_loading->loadFrameImage("object_door_break", "images/object/object_door_break_20x2.bmp", 3200, 256, 20, 2);
	_loading->loadImage("object_drum", "images/object/object_drum.bmp", 42, 54);
	...
	_loading->loadFrameImage("item_arrow", "images/item/item_pickuparrow_8x1.bmp", 272, 42,8,1);
	...
	_loading->loadImage("item_molotov", "images/item/item_molotov.bmp", 18, 40);
	_loading->loadImage("item_molotov_get", "images/item/item_molotov_get.bmp", 26, 48);
	...
	_loading->loadImage("boss_lazer_ground_small", "images/boss/boss_lazer_ground_small_1x10.bmp", 2500, 21);
	...
	_loading->loadImage("boss_warning", "images/boss/boss_warning.bmp", 770, 2);
...
{
	//etc
	_loading->loadSound("stage", "sounds/bgm_bunker.mp3", true, true);
	_loading->loadSound("stage4", "sounds/bgm_stage4.mp3", true, true);
	_loading->loadSound("stage5", "sounds/bgm_stage5_full.mp3", true, true);
	_loading->loadSound("stage5_ending", "sounds/bgm_ending.mp3", true, true);
	_loading->loadSound("title", "sounds/bgm_title.mp3", true, true);
	
	_loading->loadSound("explosion1", "sounds/explosion1.wav", false, false);
	_loading->loadSound("explosion2", "sounds/explosion2.wav", false, false);
	_loading->loadSound("explosion3", "sounds/explosion3.wav", false, false);
	_loading->loadSound("start", "sounds/start.wav", false, false);
	_loading->loadSound("clear", "sounds/clear.wav", false, false);
	_loading->loadSound("go", "sounds/go.wav", false, false);
	_loading->loadSound("beep", "sounds/beep.wav", false, false);
	
	//플레이어 사운드
	_loading->loadSound("p_slash1", "sounds/player/slash1.wav",false,false);
	_loading->loadSound("p_slash2", "sounds/player/slash2.wav",false,false);
	_loading->loadSound("p_slash3", "sounds/player/slash3.wav",false,false);
	_loading->loadSound("p_roll", "sounds/player/roll.wav",false,false);
	_loading->loadSound("p_jump", "sounds/player/jump.wav",false,false);
	_loading->loadSound("p_land", "sounds/player/land.wav",false,false);
	_loading->loadSound("p_run1", "sounds/player/run1.wav", false, false);
	_loading->loadSound("p_run2", "sounds/player/run2.wav", false, false);
	_loading->loadSound("p_run3", "sounds/player/run3.wav", false, false);
	_loading->loadSound("p_run4", "sounds/player/run4.wav", false, false);
	_loading->loadSound("p_reflect", "sounds/player/reflect.wav", false, false);
	_loading->loadSound("p_dead", "sounds/player/dead.wav", false, false);
	_loading->loadSound("p_doorbreak", "sounds/player/doorbreak.wav", false, false);
	_loading->loadSound("p_wallgrab", "sounds/player/grabwall.wav", false, false);
	_loading->loadSound("p_pick", "sounds/player/pick.wav", false, false);
	_loading->loadSound("p_throw", "sounds/player/throw.wav", false, false);
	_loading->loadSound("p_walljump1", "sounds/player/walljump1.wav", false, false);
	_loading->loadSound("p_walljump2", "sounds/player/walljump2.wav", false, false);
	_loading->loadSound("p_walljump3", "sounds/player/walljump3.wav", false, false);
	_loading->loadSound("breath_in", "sounds/player/breath_in.wav", false, false);
	_loading->loadSound("breath_out", "sounds/player/breath_out.wav", false, false);
	_loading->loadSound("song_play", "sounds/player/song_play.wav", false, false);

	_loading->loadSound("slow_in", "sounds/player/slow_in.mp3", false, false);
	_loading->loadSound("slow_out", "sounds/player/slow_out.mp3", false, false);
	
	//에너미 사운드
	_loading->loadSound("blood1", "sounds/enemy/bloodsplat1.wav", false, false);
	_loading->loadSound("blood2", "sounds/enemy/bloodsplat2.wav", false, false);
	_loading->loadSound("blood3", "sounds/enemy/bloodsplat3.wav", false, false);
	_loading->loadSound("blood4", "sounds/enemy/bloodsplat4.wav", false, false);
	_loading->loadSound("death_bottle", "sounds/enemy/death_bottle.wav", false, false);
	_loading->loadSound("death_door", "sounds/enemy/death_door.wav", false, false);
	_loading->loadSound("death_bullet", "sounds/enemy/death_bullet.wav", false, false);
	_loading->loadSound("death_sword1", "sounds/enemy/death_sword1.wav", false, false);
	_loading->loadSound("death_sword2", "sounds/enemy/death_sword2.wav", false, false);
	_loading->loadSound("death_turret", "sounds/enemy/death_turret.wav", false, false);
	_loading->loadSound("death_turret2", "sounds/enemy/death_turret2.wav", false, false);
	_loading->loadSound("e_punch", "sounds/enemy/punch.wav", false, false);
	_loading->loadSound("e_swing", "sounds/enemy/swing.wav", false, false);
	_loading->loadSound("e_fire", "sounds/enemy/fire.wav", false, false);
	_loading->loadSound("ground", "sounds/enemy/ground.wav");
	
	//오브젝트 사운드
	_loading->loadSound("bottle", "sounds/object/bottle.wav", false, false);
	_loading->loadSound("knife", "sounds/object/knife.wav", false, false);
	_loading->loadSound("glass", "sounds/object/glass.wav", false, false);
	
	//보스 사운드
	_loading->loadSound("aim_h", "sounds/boss/aimtop.wav", false, false);
	_loading->loadSound("aim_v", "sounds/boss/aimground.wav", false, false);
	_loading->loadSound("dash", "sounds/boss/dash.wav", false, false);
	_loading->loadSound("lazer", "sounds/boss/lazer.wav", false, false);
	_loading->loadSound("predash", "sounds/boss/predash.wav", false, false);
	_loading->loadSound("teleport", "sounds/boss/teleport.wav", false, false);
	_loading->loadSound("sticky", "sounds/boss/sticky.wav", false, false);
	_loading->loadSound("boom", "sounds/boss/boom.wav", false, false);
	_loading->loadSound("shoot", "sounds/boss/shoot.wav", false, false);
